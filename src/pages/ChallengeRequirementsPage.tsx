      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-4">
            IntelliTech Hackathon: Engineering Smart Solutions – Innovate. Build. Transform with Intelligent Systems
          </p>
          <p className="text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            Participants must meet the following requirements to ensure that all submissions are impactful, ethical and aligned with the goals of the IntelliTech Hackathon.
          </p>
        </div>
